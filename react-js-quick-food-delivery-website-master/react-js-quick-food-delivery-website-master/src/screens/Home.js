    ...
    return (
      <div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-lg-4 col-md-4 px-5">
                ...
                <p className="mb-4">He wants to live tomorrow. For two, but pure. To-morrow the mass of the mass, let it be the most important of the frontiers, was the quiver of football.</p>
              </div>
              <div className="col-12 col-lg-4 col-md-4 px-5">
                <span className="round-border my-4">
                ...
                <p className="mb-4">He wants to say. For two, but pure. To-morrow the mass of the mass, let it be the most important of the frontiers, was the quiver of football.</p>
              </div>
              <div className="col-12 col-lg-4 col-md-4 px-5">
                <span className="round-border my-4">
                ...
                <p className="mb-4">For he is pure. To-morrow the mass of the mass, let it be the most important of the frontiers, was the quiver of football.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-fluid text-center py-5 home-cont3">
          ...
          <p className="text-white mb-3">The children just need the nibh luctus semper at ut tulus.</p>
        ...
        <div className="container-fluid py-5">
          <div className="py-4">
            ...
            <p className="text-center">When the educated citizens become involved in the financing of the deterrent.</p>
          </div>
          <div className="container">
            <div className="row">
